...
| 8   | Session Booking / Time Validation | Sessions are greyed out for entire day instead of checking actual start time |  Medium  |  Open  | Reproduction: Current implementation only checks session date, not time. A session scheduled for 6:00 PM today is greyed out even at 2:00 PM.<br>Expected: Sessions should only be greyed out and unclickable once their actual start time has passed. A 6:00 PM session should remain bookable until 6:00 PM, not be disabled at midnight.                                                   |
