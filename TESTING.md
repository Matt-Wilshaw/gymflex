...
| 6   | Admin Panel / Routing           | Admin panel link on deployed site routes to localhost instead of production URL |  Medium  |  Open  | Reproduction: Click "Admin" button on deployed Heroku site; redirects to `http://127.0.0.1:8000/admin/` instead of `https://gymflex-5bb1d582f94c.herokuapp.com/admin/`.<br>Expected: Admin link should use relative URL or environment-aware base URL to work in both local and production environments.                                                   |
